...
| Severidad EDx · Polineuropatía diabética | [`severidad-diabetica/`](severidad-diabetica/) | Calculadora de severidad electrofisiológica: grado discreto (estadiaje somático N0–N3, Davies 2023) y Z-compuesto continuo de amplitud/velocidad (Dunker 2021), a partir de las amplitudes y velocidades del paciente y los valores de referencia de Buschbacher (reutiliza los datos de `valores-adultos/_datos/`) |
